...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const formNuevoComentario = document.querySelector("#form-crear-resena");
    ...
    const fetchComentarios = async () => {
        try {
            ...
            posteos.forEach(posteo => {
                ...
                botonEliminar.className = "clickable";
                ...
                botonEditar.addEventListener("click", () => {
                    ...
                    window.location.href = `resenas-editar.html?id=${posteo.id}`
                })
                botonEditar.className = "clickable";
